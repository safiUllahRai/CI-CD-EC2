...
class NgCliFileSystem {
    ...
    copySync(srcPath, destPath) {
        if (this.fileExistsSync(srcPath)) {
            ...
            paths.forEach(path => this.copySync(path.name, (0, path_1.join)(destPath, (0, path_1.basename)(path.name))));
        }
    }
    delete(path) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    getAllFilePaths(path = '/', foundedFiles = []) {
        ...
        foundedFiles.push(...files.map(file => (0, path_1.join)(path, file)));
        directories
            .filter(dir => !dir.startsWith('.') && dir !== 'node_modules')
            .forEach(dir => this.getAllFilePaths((0, path_1.join)(path, dir), foundedFiles));
        return foundedFiles;
    }
}
